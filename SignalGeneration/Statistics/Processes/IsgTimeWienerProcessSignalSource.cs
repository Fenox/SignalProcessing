...
{
    public class IsgTimeWienerProcessSignalSource : ISGTimeDiscreteSignalSource<Point<int>, PointDouble, double>
    {
        ...
        private IsgTimeWienerProcessSignalSource() { }

        public IsgTimeWienerProcessSignalSource(double timeResolution, int seed)
        {
        ...
        public IsgTimeWienerProcessSignalSource(double timeResolution)
        {
            _wienerProcess.Add(0);
            TimeResolution = timeResolution;
            _rand = new Random();
