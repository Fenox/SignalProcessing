...
{
    public class IsgTimeItoProcessSignalSource : ISGTimeDiscreteSignalSource<Point<int>, PointDouble, double>
    {
    ...
    public class IsgTimeBrownianMotionSignalSource : IsgTimeItoProcessSignalSource
    {
        public IsgTimeBrownianMotionSignalSource(int dim, double timeDelta, double[] drift, double[] vola) : 
            base(dim,
                timeDelta, 
